...
function ProfileArt() { return <div className="hero-art reveal reveal-delay" style={{ overflow: 'hidden' }}><div className="art-orbit orbit-one" /><div className="art-orbit orbit-two" /><div className="profile-tile"><img src="/images/homepagephoto.jpg" alt="Hemant Chaudhary outdoors wearing sunglasses" /><span className="profile-kicker">Frontend developer</span><span className="profile-name">Hemant<br />Chaudhary</span></div><span className="floating-tag tag-top">React + Next.js</span><span className="floating-tag tag-bottom">Build with purpose ✦</span></div>; }
